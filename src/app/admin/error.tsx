...
export default function AdminError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 px-4 py-24 text-center relative overflow-hidden">
      <div
        className="pointer-events-none absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 opacity-15"
        style={{
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        >
          <ShieldAlert className="h-8 w-8" style={{ color: "rgba(196,28,53,0.8)" }} />
        </div>
