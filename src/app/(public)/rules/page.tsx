...
export default function RulesPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <div className="mb-10">
        <p className="text-xs font-semibold uppercase tracking-widest text-brand mb-2">Official</p>
      ...
      <div className="mt-12 pt-8 border-t border-border flex items-center justify-between">
        ...
        <p className="text-xs text-muted-foreground">Questions? Reach out in the Discord.</p>
      </div>
    </div>
  )
}
