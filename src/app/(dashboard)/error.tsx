  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 px-4 py-24 text-center relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(196,28,53,0.7), transparent 70%)",
          filter: "blur(60px)",
        }}
        aria-hidden
      />
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground max-w-sm text-sm leading-relaxed">
            An error occurred while loading this page. You can try again or return to your dashboard.
          </p>
          {error.digest && (
