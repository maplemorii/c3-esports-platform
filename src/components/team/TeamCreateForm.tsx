 ...
 * TeamCreateForm
 *
 * Self-contained client component for creating a new team.
 * Calls POST /api/teams and calls onSuccess(teamId) on completion.
 *
 * Usage:
 *   <TeamCreateForm onSuccess={(id) => router.push(`/team/${id}`)} />
 */
